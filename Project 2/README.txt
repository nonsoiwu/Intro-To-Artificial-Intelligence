Resolution Theorem Prover written in Python
...
Source code: theorem_prover.py

Tests for module functionality: theorem_prover_tests.py

Tests for Theorem class (derived from 'test-prover.txt'): test_prover.py